...
(C.1) faber_fs_thread_test (6 out of 6 pts)
    What is your kshell command to invoke faber_fs_thread_test(): thread_test
(C.2) faber_directory_test (4 out of 4 pts)
    What is your kshell command to invoke faber_directory_test(): directory_test
...
1)  Names and USC e-mail addresses of team members:
        Chia-Hao Chang (cchang82@usc.edu)
        Yu-Hsuan Lu (luyuhsua@usc.edu)
        Shih-Hsun Nien (snien@usc.edu)
        Chih Ken Yao (chihkeny@usc.edu)
